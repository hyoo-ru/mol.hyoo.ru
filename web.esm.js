...
(function ($) {
    ...
    __decorate([
        $.$mol_mem
    ], $mol_app_studio.prototype, "Speech_toggle_icon", null);
    __decorate([
        $.$mol_mem
    ], $mol_app_studio.prototype, "speech_enabled", null);
    __decorate([
        $.$mol_mem
    ], $mol_app_studio.prototype, "Speech_toggle", null);
    __decorate([
        $.$mol_mem
...
(function ($) {
    class $hyoo_tree extends $.$mol_book2 {
        ...
        Result() {
            const obj = new this.$.$mol_page();
            obj.title = () => this.$.$mol_locale.text('$hyoo_tree_Result_title');
            obj.tools = () => [
                this.Close()
            ];
            obj.body = () => [
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_tree extends $.$hyoo_tree {
            ...
            source(next) {
                var _a;
                return (_a = this.$.$mol_state_arg.value('source', next)) !== null && _a !== void 0 ? _a : this.$.$mol_fetch.text('hyoo/tree/tree.view.tree');
            }
        }
        __decorate([
            $.$mol_mem
