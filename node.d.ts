...
declare namespace $ {
    ...
    class $mol_app_demo_menu2 extends $mol_page {
        Body(): $$.$mol_scroll;
    ...
    class $mol_app_demo_menu extends $mol_page {
        ...
        tags_selected(val?: any): readonly string[];
        tags_dictionary(): {};
...
declare namespace $.$$ {
    ...
    class $mol_app_demo_menu2 extends $.$mol_app_demo_menu2 {
