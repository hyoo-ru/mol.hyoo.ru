...
declare namespace $ {
     ...
     */
    let $mol_gap: Record<"text" | "block" | "emoji" | "blur" | "page" | "space" | "round", $mol_style_func<"var", unknown>>;
}
...
declare namespace $ {
	...
	type $mol_locale_select_langs__1 = $mol_type_enforce<
		`en`
		,
		string
	>
...
declare namespace $.$$ {
    class $mol_locale_select extends $.$mol_locale_select {
        value(next?: string): string;
        dictionary(next?: Record<string, string>): Record<string, string>;
    }
}
...
declare namespace $.$$ {
    class $mol_vary_edit extends $.$mol_vary_edit {
        ...
        type_auto(): "Text" | "Null" | "Bool" | "Bint" | "Real" | "Date" | "List" | "Tupl";
